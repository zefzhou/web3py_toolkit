...
def init_web3_and_account(endpoint_name: str, endpoint: str = '', private_key: str = '') -> Tuple:
...
def get_default_tx_params(w3: Web3, account: Account, chain_id: str = None, to: Address = None, data: str = None, val: Wei = Wei(0), gas: Wei = Wei(100000), gas_price: Optional[Wei] = None):
...
def send_tx_and_wait_recipt(w3: Web3, signed_tx, timeout: int = 120) -> bool:
    try:
...
def send(w3: Web3, account: Account, chain_id: str = None, f: ContractFunction = None, gas: Wei = Wei(100000), gas_price: Optional[Wei] = None, to: Address = None, data: str = None, val: Wei = Wei(0), timeout: int = 120):
    tx_params = get_default_tx_params(w3=w3, account=account, chain_id=chain_id, to=to,
                                      data=data, val=val, gas=gas, gas_price=gas_price)
    if f is not None:
